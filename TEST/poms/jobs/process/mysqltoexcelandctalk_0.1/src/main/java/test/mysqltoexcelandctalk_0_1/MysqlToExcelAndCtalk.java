...
package test.mysqltoexcelandctalk_0_1;
...
/**
 * Job: MysqlToExcelAndCtalk Purpose: export mysql user<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class MysqlToExcelAndCtalk implements TalendJob {
	...
	private final String jobName = "MysqlToExcelAndCtalk";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MysqlToExcelAndCtalk.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MysqlToExcelAndCtalk.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_1 = "jdbc:mysql://" + "127.0.0.1" + ":" + "3306" + "/" + "mysql" + "?"
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:mRFnjootSYJzmHHb4SUX+WYae2jO9iXH8/YCMiXZl+aKohOnnZFCjHco");
	...
	public static class userStruct implements routines.system.IPersistableRow<userStruct> {
		final static byte[] commonByteArrayLock_TEST_MysqlToExcelAndCtalk = new byte[0];
		static byte[] commonByteArray_TEST_MysqlToExcelAndCtalk = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_MysqlToExcelAndCtalk.length) {
					if (length < 1024 && commonByteArray_TEST_MysqlToExcelAndCtalk.length == 0) {
						commonByteArray_TEST_MysqlToExcelAndCtalk = new byte[1024];
					} else {
						commonByteArray_TEST_MysqlToExcelAndCtalk = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_MysqlToExcelAndCtalk, 0, length);
				strReturn = new String(commonByteArray_TEST_MysqlToExcelAndCtalk, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_MysqlToExcelAndCtalk) {
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fileName_tFileOutputExcel_2 = "D:/Programs/TOS_DI-Win32-20200219_1130-V7.3.1/workspace/"
						+ jobName + "_" + TalendDate.formatDate("yyyyMMdd", new Date()) + ".xls";
...
//create directory only if not exists		  
				...
				if (startRowNum_tFileOutputExcel_2 == 0) {
					// modif end
					// modif start
					writableSheet_tFileOutputExcel_2.addCell(
							new jxl.write.Label(0, nb_line_tFileOutputExcel_2, "user", format_tFileOutputExcel_2));
					// modif end
					fitWidth_tFileOutputExcel_2[0] = fitWidth_tFileOutputExcel_2[0] > 4 ? fitWidth_tFileOutputExcel_2[0]
							: 4;
					// modif start
					writableSheet_tFileOutputExcel_2.addCell(
							new jxl.write.Label(1, nb_line_tFileOutputExcel_2, "host", format_tFileOutputExcel_2));
					// modif end
...
// ###############################
				...
				String dbquery_tDBInput_2 = "select user, host from user";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row1.user = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
						}
						if (colQtyInRs_tDBInput_2 < 2) {
							row1.host = null;
						} else {

							row1.host = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
						}
...
// # Output table : 'user'
							user_tmp.user = row1.user;
							user_tmp.host = row1.host;
							user = user_tmp;
// ###############################
...
//modif end
										user.user, format_tFileOutputExcel_2);
//modif start					
...
//modif end
										user.host, format_tFileOutputExcel_2);
//modif start					
								// If we keep the cell format from the existing cell in sheet
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final Process ps_tSystem_1 = runtime_tSystem_1.exec(
						"cmd /c java -jar CompactCTalkSender.jar 20800854 IXON@la5ohrs 5957083 D:/Programs/TOS_DI-Win32-20200219_1130-V7.3.1/workspace/"
								+ jobName + "_" + TalendDate.formatDate("yyyyMMdd", new Date()) + ".xls",
	...
	public static void main(String[] args) {
		final MysqlToExcelAndCtalk MysqlToExcelAndCtalkClass = new MysqlToExcelAndCtalk();

		int exitCode = MysqlToExcelAndCtalkClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MysqlToExcelAndCtalk.class.getClassLoader()
					.getResourceAsStream("test/mysqltoexcelandctalk_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = MysqlToExcelAndCtalk.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : MysqlToExcelAndCtalk");
		}
...
/************************************************************************************************
 * 55148 characters generated by Talend Open Studio for Data Integration on the
 * 2020년 6월 22일 (월) 오후 4시 09분 35초
 ************************************************************************************************/