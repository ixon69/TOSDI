...
package test.durtoexcelandctalk_in_0_4;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5TQZFOjh7HULlcn/OfhfgChnzOTFasr74YA8uvWhloT5gQ==");
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_TEST_DurToExcelAndCtalk_IN = new byte[0];
    static byte[] commonByteArray_TEST_DurToExcelAndCtalk_IN = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_DurToExcelAndCtalk_IN.length) {
				if(length < 1024 && commonByteArray_TEST_DurToExcelAndCtalk_IN.length == 0) {
   					commonByteArray_TEST_DurToExcelAndCtalk_IN = new byte[1024];
				} else {
   					commonByteArray_TEST_DurToExcelAndCtalk_IN = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_DurToExcelAndCtalk_IN, 0, length);
			strReturn = new String(commonByteArray_TEST_DurToExcelAndCtalk_IN, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_DurToExcelAndCtalk_IN) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DurToExcelAndCtalk_IN.class.getClassLoader().getResourceAsStream("test/durtoexcelandctalk_in_0_4/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     124231 characters generated by Talend Open Studio for Data Integration 
 *     on the 2020년 9월 9일 (수) 오후 1시 41분 45초
 ************************************************************************************************/