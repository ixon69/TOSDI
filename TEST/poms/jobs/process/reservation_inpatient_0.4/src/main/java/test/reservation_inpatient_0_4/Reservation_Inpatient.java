...
package test.reservation_inpatient_0_4;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:QOXlODqVAKciZH1oAB93LDJHKB4zf2+uRIniIgtbdJyVkA==");
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_TEST_Reservation_Inpatient = new byte[0];
    static byte[] commonByteArray_TEST_Reservation_Inpatient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_Reservation_Inpatient.length) {
				if(length < 1024 && commonByteArray_TEST_Reservation_Inpatient.length == 0) {
   					commonByteArray_TEST_Reservation_Inpatient = new byte[1024];
				} else {
   					commonByteArray_TEST_Reservation_Inpatient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_Reservation_Inpatient, 0, length);
			strReturn = new String(commonByteArray_TEST_Reservation_Inpatient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_Reservation_Inpatient) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Reservation_Inpatient.class.getClassLoader().getResourceAsStream("test/reservation_inpatient_0_4/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     136451 characters generated by Talend Open Studio for Data Integration 
 *     on the 2020년 10월 12일 (월) 오후 4시 12분 12초
 ************************************************************************************************/