...
package bucheon.reservation_inpatient_0_4;
...
/**
 * Job: Reservation_Inpatient Purpose: export dur suspect<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Reservation_Inpatient implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(cmctalk_out_user != null){
				
					this.setProperty("cmctalk_out_user", cmctalk_out_user.toString());
				
			}
			
			if(cmctalk_out_password != null){
				
					this.setProperty("cmctalk_out_password", cmctalk_out_password.toString());
				
			}
			
			if(cmctalk_out_roomno != null){
				
					this.setProperty("cmctalk_out_roomno", cmctalk_out_roomno.toString());
				
			}
			
		}

public String cmctalk_out_user;
public String getCmctalk_out_user(){
	return this.cmctalk_out_user;
}
public String cmctalk_out_password;
public String getCmctalk_out_password(){
	return this.cmctalk_out_password;
}
public String cmctalk_out_roomno;
public String getCmctalk_out_roomno(){
	return this.cmctalk_out_roomno;
}
	}
	...
	private final String jobName = "Reservation_Inpatient";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Reservation_Inpatient.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Reservation_Inpatient.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:cgsqfqo1Mbt02ETaRgd0YH0lOkPq5wxXke128qbceF9BCQ==");
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_BUCHEON_Reservation_Inpatient = new byte[0];
    static byte[] commonByteArray_BUCHEON_Reservation_Inpatient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BUCHEON_Reservation_Inpatient.length) {
				if(length < 1024 && commonByteArray_BUCHEON_Reservation_Inpatient.length == 0) {
   					commonByteArray_BUCHEON_Reservation_Inpatient = new byte[1024];
				} else {
   					commonByteArray_BUCHEON_Reservation_Inpatient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BUCHEON_Reservation_Inpatient, 0, length);
			strReturn = new String(commonByteArray_BUCHEON_Reservation_Inpatient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BUCHEON_Reservation_Inpatient) {
 ...
 */
	...
	java.io.File file_tFileInputProperties_1 = new java.io.File("D:/data/ResvInpatient/CompactCTalkSender/ResvInpatient.properties");
 ...
 */
  ...
  try{
        if(key_tContextLoad_2!=null && "cmctalk_out_user".equals(key_tContextLoad_2))
        {
           context.cmctalk_out_user=value_tContextLoad_2;
        }

        if(key_tContextLoad_2!=null && "cmctalk_out_password".equals(key_tContextLoad_2))
        {
           context.cmctalk_out_password=value_tContextLoad_2;
        }

        if(key_tContextLoad_2!=null && "cmctalk_out_roomno".equals(key_tContextLoad_2))
        {
           context.cmctalk_out_roomno=value_tContextLoad_2;
        }
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "WITH KIJUN AS (\nSELECT TO_CHAR(SYSDATE + DECODE(TO_CHAR(SYSDATE, 'd'), 2, 3, 3, 3, 4, 3, 5, 4, 6, 4, 0), 'YYYYMMDD') F"
+"ROMDD,\n       TO_CHAR(SYSDATE + DECODE(TO_CHAR(SYSDATE, 'd'), 2, 3, 3, 3, 4, 4, 5, 4, 6, 5, 0), 'YYYYMMDD') TODD\n  FRO"
+"M DUAL\n), SLCT AS (\nSELECT CASE WHEN ADRV.INFLAG = 'Y' THEN '입원'\n            WHEN ADRV.INRSRVSTAT='S' THEN '의뢰'\n  		"
+"			WHEN ADRV.INRSRVSTAT='R' THEN '예약'\n  					WHEN ADRV.INRSRVSTAT='A' THEN '입원'\n  	        END AS GUBUN, --구분\n       "
+"ADRV.PID, --등록번호\n       PTBS.HNGNM, --이름\n       PTBS.SEX || '/'\n                || COM.FN_ZZ_GETAGE('-',\n           "
+"                         '-',\n                                    ADRV.INRSRVACPTDD,\n                                 "
+"   'B',\n                                    PTBS.BRTHDD) AS SEX, --성별\n       PTBS.MPPHONTEL, --핸드폰번호\n       ADRV.INHO"
+"PEDD, --입원예정일\n       ZDEP.DEPTHNGNM, --진료과\n      (SELECT CODE.CDNM\n          FROM COM.ZBCMCODE CODE\n         WHERE C"
+"ODE.CDID        = ADRV.COOPTEAMCD\n           AND CODE.VALIFROMDD <=  KIJUN.FROMDD\n           AND CODE.VALITODD   >=  K"
+"IJUN.TODD\n           AND CODE.CDGRUPID    ='M0525'   ) AS COLLABOTEAM, --협진팀명\n       USRB.USERNM AS DOCTOR, --주치의\n   "
+"    MRCD.TRGTCDNM AS INGUBUN, --입원구분\n       CASE WHEN ADRV.AMPMFLAG='A' THEN '오전'\n			WHEN ADRV.AMPMFLAG='P' THEN '오후' "
+"END AS REVGUBUN, --예약구분\n       ADRV.CPYN AS CP, --CP여부\n      (SELECT B.TERMENGNM\n         FROM EMR.MMOHDIAG A,\n     "
+"          EMR.MRTMTERM B\n        WHERE A.PID        = ADRV.PID\n          AND A.ORDDD     >= ADRV.INHOPEDD\n          A"
+"ND A.ORDDEPTCD  = ADRV.ORDDEPTCD\n          AND A.INSTCD     =  '014'\n          AND A.INSTCD     = B.INSTCD\n          "
+"AND A.DIAGCD     = B.TERMCD\n          AND A.GENRFLAGCD = '-'\n          AND A.DIAGHISTCD = 'O'\n          AND A.DIAGTYP"
+"ECD = 'R'\n          AND B.TERMFLAG   = '0'\n          AND A.DIAGDD    >= B.TERMFROMDD\n          AND A.DIAGDD    <  B.T"
+"ERMTODD\n          AND ROWNUM = 1) AS DIAG, --진단명\n       CASE WHEN ADRV.SCHEOPDD IS NOT NULL THEN DECODE(ADRV.SCHEOPDD,"
+" '-', NULL , SUBSTR(ADRV.SCHEOPDD, 0, 4)\n                                                        ||'/'||SUBSTR(ADRV.SCH"
+"EOPDD, 5, 2)\n                                                        || '/'||SUBSTR(ADRV.SCHEOPDD, 7, 2))\n            "
+"END                      AS SURGERYHOPEDD, --수술예정일,\n      (SELECT B.TERMENGNM\n         FROM EMR.MMOHDIAG A,\n         "
+"     EMR.MRTMTERM B\n        WHERE A.PID        = ADRV.PID\n          AND A.ORDDD     >= ADRV.INHOPEDD\n          AND A."
+"ORDDEPTCD  = ADRV.ORDDEPTCD\n          AND A.INSTCD     =  '014'\n          AND A.INSTCD     = B.INSTCD\n          AND A"
+".DIAGCD     = B.TERMCD\n          AND A.GENRFLAGCD = '-'\n          AND A.DIAGHISTCD = 'O'\n          AND A.DIAGTYPECD ="
+" 'O'\n          AND B.TERMFLAG   = '9'\n          AND A.DIAGDD    >= B.TERMFROMDD\n          AND A.DIAGDD    <  B.TERMTO"
+"DD\n          AND ROWNUM = 1) AS SURGERY, --수술명\n       ADRV.DRREM AS DRNOTE, --의료진참고사항\n      (CASE WHEN ADRV.WARDTYPEC"
+"D = '-'  THEN ADRV.ASSGROOM\n            WHEN ADRV.WARDTYPECD = '01' THEN (SELECT CODE.CDNM\n                           "
+"                     FROM COM.ZBCMCODE CODE\n                                               WHERE CODE.CDGRUPID ='P0474'"
+"\n                                                 AND CODE.CDID = ADRV.WARDTYPECD\n                                    "
+"             AND CODE.VALIFROMDD <= ADRV.INRSRVACPTDD\n                                                 AND CODE.VALITOD"
+"D   >= ADRV.INRSRVACPTDD ) || '/' ||\n                                             (SELECT DEPT.DEPTHNGNM\n             "
+"                                   FROM COM.ZSDDDEPT DEPT\n                                               WHERE DEPT.INS"
+"TCD = ADRV.INSTCD\n                                                 AND DEPT.DEPTCD = ADRV.SPECWARDCD\n                 "
+"                                AND DEPT.VALIFROMDD <= ADRV.INRSRVACPTDD\n                                              "
+"   AND DEPT.VALITODD   >= ADRV.INRSRVACPTDD) || '/' || ADRV.ASSGROOM\n            ELSE (SELECT CODE.CDNM\n              "
+"      FROM COM.ZBCMCODE CODE\n                   WHERE CODE.CDGRUPID ='P0474'\n                     AND CODE.CDID = ADRV"
+".WARDTYPECD\n                     AND CODE.VALIFROMDD <= ADRV.INRSRVACPTDD\n                     AND CODE.VALITODD   >= "
+"ADRV.INRSRVACPTDD )  || '/' || ADRV.ASSGROOM\n            END)                      AS     ROOM       ,   -- 병실\n       "
+"ADRV.INRSRVREM AS PAMNOTE --원무참고사항\n  FROM PAM.PMIHADRV ADRV,\n       COM.ZSUMUSRB USRB,\n       PAM.PMCMPTBS PTBS,\n   "
+"    COM.ZSDDDEPT ZDEP,\n       EMR.MMBDHRCD MRCD,\n       KIJUN\n WHERE ADRV.INRSRVSTAT IN ('S', 'R')\n   AND ADRV.ORDDR"
+"ID = USRB.USERID\n   AND ADRV.PID     = PTBS.PID\n   AND ADRV.INSTCD  = PTBS.INSTCD\n   AND ADRV.INSTCD  =  '014'\n   AN"
+"D USRB.USERFROMDD <= ADRV.INHOPEDD\n   AND USRB.USERTODD   >= ADRV.INHOPEDD\n   AND ZDEP.INSTCD = PTBS.INSTCD\n   AND ZD"
+"EP.DEPTCD = ADRV.ORDDEPTCD\n   AND ZDEP.VALIFROMDD<= ADRV.INHOPEDD\n   AND ZDEP.VALITODD >= ADRV.INHOPEDD\n   AND MRCD.I"
+"NSTCD = PTBS.INSTCD\n   AND MRCD.TRGTCD = ADRV.ERREGLYN\n   AND MRCD.HARDCDNO='90'\n   AND MRCD.VALIFROMDD <=ADRV.INHOPE"
+"DD\n   AND MRCD.VALITODD >=ADRV.INHOPEDD\n   AND ADRV.INHOPEDD   >=  KIJUN.FROMDD\n   AND ADRV.INHOPEDD   <=  KIJUN.TODD"
+"\n ORDER BY INHOPEDD\n)\nSELECT COUNT(*) CNT\n  FROM SLCT";
...
public static class userStruct implements routines.system.IPersistableRow<userStruct> {
    ...
    static byte[] commonByteArray_BUCHEON_Reservation_Inpatient = new byte[0];
			    ...
			    public String INHOPEDD;

				public String getINHOPEDD () {
					return this.INHOPEDD;
				}
			    ...
			    public String COLLABOTEAM;

				public String getCOLLABOTEAM () {
					return this.COLLABOTEAM;
				}
			    ...
			    public String INGUBUN;

				public String getINGUBUN () {
					return this.INGUBUN;
				}
				
			    public String RESVGUBUN;

				public String getRESVGUBUN () {
					return this.RESVGUBUN;
				}
			    ...
			    public String SURGERYHOPEDD;

				public String getSURGERYHOPEDD () {
					return this.SURGERYHOPEDD;
				}
			    ...
			    public String PAMNOTE;

				public String getPAMNOTE () {
					return this.PAMNOTE;
				}
		...
		synchronized(commonByteArrayLock_BUCHEON_Reservation_Inpatient) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.INHOPEDD = readString(dis);
					
					this.DEPTHNGNM = readString(dis);
					
					this.COLLABOTEAM = readString(dis);
					
					this.DOCTOR = readString(dis);
					
					this.INGUBUN = readString(dis);
					
					this.RESVGUBUN = readString(dis);
					
					this.CP = readString(dis);
					
					this.DIAG = readString(dis);
					
					this.SURGERYHOPEDD = readString(dis);
					
					this.SURGERY = readString(dis);
					
					this.DRNOTE = readString(dis);
					
					this.ROOM = readString(dis);
					
					this.PAMNOTE = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.COLLABOTEAM,dos);
					
					// String
				
						writeString(this.DOCTOR,dos);
					
					// String
				
						writeString(this.INGUBUN,dos);
					
					// String
				
						writeString(this.RESVGUBUN,dos);
					...
					// String
						...
						writeString(this.DIAG,dos);
					
					// String
				
						writeString(this.SURGERYHOPEDD,dos);
					
					// String
				
						writeString(this.SURGERY,dos);
					
					// String
				
						writeString(this.DRNOTE,dos);
    ...
    public String toString() {
		...
		sb.append(",INHOPEDD="+INHOPEDD);
		sb.append(",DEPTHNGNM="+DEPTHNGNM);
		sb.append(",COLLABOTEAM="+COLLABOTEAM);
		sb.append(",DOCTOR="+DOCTOR);
		sb.append(",INGUBUN="+INGUBUN);
		sb.append(",RESVGUBUN="+RESVGUBUN);
		sb.append(",CP="+CP);
		sb.append(",DIAG="+DIAG);
		sb.append(",SURGERYHOPEDD="+SURGERYHOPEDD);
		sb.append(",SURGERY="+SURGERY);
		sb.append(",DRNOTE="+DRNOTE);
		sb.append(",ROOM="+ROOM);
		sb.append(",PAMNOTE="+PAMNOTE);
	    sb.append("]");
...
userStruct user = new userStruct();
	...
	currentComponent="tFileOutputExcel_2";
		...
		String fileName_tFileOutputExcel_2="D:/data/ResvInpatient/입원예약정보_"+TalendDate.formatDate("yyyyMMdd", new Date()) + ".xls";
...
//create directory only if not exists		  
	...
	//modif end
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(0, nb_line_tFileOutputExcel_2, "GUBUN"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[0]=fitWidth_tFileOutputExcel_2[0]>5?fitWidth_tFileOutputExcel_2[0]:5;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(1, nb_line_tFileOutputExcel_2, "PID"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[1]=fitWidth_tFileOutputExcel_2[1]>3?fitWidth_tFileOutputExcel_2[1]:3;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(2, nb_line_tFileOutputExcel_2, "HNGNM"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[2]=fitWidth_tFileOutputExcel_2[2]>5?fitWidth_tFileOutputExcel_2[2]:5;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(3, nb_line_tFileOutputExcel_2, "SEX"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[3]=fitWidth_tFileOutputExcel_2[3]>3?fitWidth_tFileOutputExcel_2[3]:3;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(4, nb_line_tFileOutputExcel_2, "MPPHONTEL"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[4]=fitWidth_tFileOutputExcel_2[4]>9?fitWidth_tFileOutputExcel_2[4]:9;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(5, nb_line_tFileOutputExcel_2, "INHOPEDD"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[5]=fitWidth_tFileOutputExcel_2[5]>8?fitWidth_tFileOutputExcel_2[5]:8;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(6, nb_line_tFileOutputExcel_2, "DEPTHNGNM"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[6]=fitWidth_tFileOutputExcel_2[6]>9?fitWidth_tFileOutputExcel_2[6]:9;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(7, nb_line_tFileOutputExcel_2, "COLLABOTEAM"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[7]=fitWidth_tFileOutputExcel_2[7]>11?fitWidth_tFileOutputExcel_2[7]:11;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(8, nb_line_tFileOutputExcel_2, "DOCTOR"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[8]=fitWidth_tFileOutputExcel_2[8]>6?fitWidth_tFileOutputExcel_2[8]:6;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(9, nb_line_tFileOutputExcel_2, "INGUBUN"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[9]=fitWidth_tFileOutputExcel_2[9]>7?fitWidth_tFileOutputExcel_2[9]:7;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(10, nb_line_tFileOutputExcel_2, "RESVGUBUN"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[10]=fitWidth_tFileOutputExcel_2[10]>9?fitWidth_tFileOutputExcel_2[10]:9;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(11, nb_line_tFileOutputExcel_2, "CP"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[11]=fitWidth_tFileOutputExcel_2[11]>2?fitWidth_tFileOutputExcel_2[11]:2;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(12, nb_line_tFileOutputExcel_2, "DIAG"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[12]=fitWidth_tFileOutputExcel_2[12]>4?fitWidth_tFileOutputExcel_2[12]:4;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(13, nb_line_tFileOutputExcel_2, "SURGERYHOPEDD"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[13]=fitWidth_tFileOutputExcel_2[13]>13?fitWidth_tFileOutputExcel_2[13]:13;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(14, nb_line_tFileOutputExcel_2, "SURGERY"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[14]=fitWidth_tFileOutputExcel_2[14]>7?fitWidth_tFileOutputExcel_2[14]:7;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(15, nb_line_tFileOutputExcel_2, "DRNOTE"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[15]=fitWidth_tFileOutputExcel_2[15]>6?fitWidth_tFileOutputExcel_2[15]:6;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(16, nb_line_tFileOutputExcel_2, "ROOM"
					,format_tFileOutputExcel_2
			));
		//modif end
		fitWidth_tFileOutputExcel_2[16]=fitWidth_tFileOutputExcel_2[16]>4?fitWidth_tFileOutputExcel_2[16]:4;
		//modif start
			writableSheet_tFileOutputExcel_2.addCell(new jxl.write.Label(17, nb_line_tFileOutputExcel_2, "PAMNOTE"
					,format_tFileOutputExcel_2
			));
		//modif end
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "WITH KIJUN AS (\nSELECT TO_CHAR(SYSDATE + DECODE(TO_CHAR(SYSDATE, 'd'), 2, 3, 3, 3, 4, 3, 5, 4, 6, 4, 0), 'YYYYMMDD') F"
+"ROMDD,\n       TO_CHAR(SYSDATE + DECODE(TO_CHAR(SYSDATE, 'd'), 2, 3, 3, 3, 4, 4, 5, 4, 6, 5, 0), 'YYYYMMDD') TODD\n  FRO"
+"M DUAL\n)\nSELECT CASE WHEN ADRV.INFLAG = 'Y' THEN '입원'\n            WHEN ADRV.INRSRVSTAT='S' THEN '의뢰'\n  					WHEN ADR"
+"V.INRSRVSTAT='R' THEN '예약'\n  					WHEN ADRV.INRSRVSTAT='A' THEN '입원'\n  	        END AS GUBUN, --구분\n       ADRV.PID, -"
+"-등록번호\n       PTBS.HNGNM, --이름\n       PTBS.SEX || '/'\n                || COM.FN_ZZ_GETAGE('-',\n                      "
+"              '-',\n                                    ADRV.INRSRVACPTDD,\n                                    'B',\n  "
+"                                  PTBS.BRTHDD) AS SEX, --성별\n       PTBS.MPPHONTEL, --핸드폰번호\n       ADRV.INHOPEDD, --입원예"
+"정일\n       ZDEP.DEPTHNGNM, --진료과\n      (SELECT CODE.CDNM\n          FROM COM.ZBCMCODE CODE\n         WHERE CODE.CDID   "
+"     = ADRV.COOPTEAMCD\n           AND CODE.VALIFROMDD <=  KIJUN.FROMDD\n           AND CODE.VALITODD   >=  KIJUN.TODD\n"
+"           AND CODE.CDGRUPID    ='M0525'   ) AS COLLABOTEAM, --협진팀명\n       USRB.USERNM AS DOCTOR, --주치의\n       MRCD.TR"
+"GTCDNM AS INGUBUN, --입원구분\n       CASE WHEN ADRV.AMPMFLAG='A' THEN '오전'\n			WHEN ADRV.AMPMFLAG='P' THEN '오후' END AS RESV"
+"GUBUN, --예약구분\n       ADRV.CPYN AS CP, --CP여부\n      (SELECT B.TERMENGNM\n         FROM EMR.MMOHDIAG A,\n               "
+"EMR.MRTMTERM B\n        WHERE A.PID        = ADRV.PID\n          AND A.ORDDD     >= ADRV.INHOPEDD\n          AND A.ORDDE"
+"PTCD  = ADRV.ORDDEPTCD\n          AND A.INSTCD     =  '014'\n          AND A.INSTCD     = B.INSTCD\n          AND A.DIAG"
+"CD     = B.TERMCD\n          AND A.GENRFLAGCD = '-'\n          AND A.DIAGHISTCD = 'O'\n          AND A.DIAGTYPECD = 'R'"
+"\n          AND B.TERMFLAG   = '0'\n          AND A.DIAGDD    >= B.TERMFROMDD\n          AND A.DIAGDD    <  B.TERMTODD\n "
+"         AND ROWNUM = 1) AS DIAG, --진단명\n       CASE WHEN ADRV.SCHEOPDD IS NOT NULL THEN DECODE(ADRV.SCHEOPDD, '-', NULL"
+" , SUBSTR(ADRV.SCHEOPDD, 0, 4)\n                                                        ||'/'||SUBSTR(ADRV.SCHEOPDD, 5, "
+"2)\n                                                        || '/'||SUBSTR(ADRV.SCHEOPDD, 7, 2))\n            END       "
+"               AS SURGERYHOPEDD, --수술예정일,\n      (SELECT B.TERMENGNM\n         FROM EMR.MMOHDIAG A,\n              EMR.M"
+"RTMTERM B\n        WHERE A.PID        = ADRV.PID\n          AND A.ORDDD     >= ADRV.INHOPEDD\n          AND A.ORDDEPTCD "
+" = ADRV.ORDDEPTCD\n          AND A.INSTCD     =  '014'\n          AND A.INSTCD     = B.INSTCD\n          AND A.DIAGCD   "
+"  = B.TERMCD\n          AND A.GENRFLAGCD = '-'\n          AND A.DIAGHISTCD = 'O'\n          AND A.DIAGTYPECD = 'O'\n    "
+"      AND B.TERMFLAG   = '9'\n          AND A.DIAGDD    >= B.TERMFROMDD\n          AND A.DIAGDD    <  B.TERMTODD\n      "
+"    AND ROWNUM = 1) AS SURGERY, --수술명\n       ADRV.DRREM AS DRNOTE, --의료진참고사항\n      (CASE WHEN ADRV.WARDTYPECD = '-'  T"
+"HEN ADRV.ASSGROOM\n            WHEN ADRV.WARDTYPECD = '01' THEN (SELECT CODE.CDNM\n                                     "
+"           FROM COM.ZBCMCODE CODE\n                                               WHERE CODE.CDGRUPID ='P0474'\n        "
+"                                         AND CODE.CDID = ADRV.WARDTYPECD\n                                              "
+"   AND CODE.VALIFROMDD <= ADRV.INRSRVACPTDD\n                                                 AND CODE.VALITODD   >= ADR"
+"V.INRSRVACPTDD ) || '/' ||\n                                             (SELECT DEPT.DEPTHNGNM\n                       "
+"                         FROM COM.ZSDDDEPT DEPT\n                                               WHERE DEPT.INSTCD = ADRV"
+".INSTCD\n                                                 AND DEPT.DEPTCD = ADRV.SPECWARDCD\n                           "
+"                      AND DEPT.VALIFROMDD <= ADRV.INRSRVACPTDD\n                                                 AND DEP"
+"T.VALITODD   >= ADRV.INRSRVACPTDD) || '/' || ADRV.ASSGROOM\n            ELSE (SELECT CODE.CDNM\n                    FROM"
+" COM.ZBCMCODE CODE\n                   WHERE CODE.CDGRUPID ='P0474'\n                     AND CODE.CDID = ADRV.WARDTYPEC"
+"D\n                     AND CODE.VALIFROMDD <= ADRV.INRSRVACPTDD\n                     AND CODE.VALITODD   >= ADRV.INRSR"
+"VACPTDD )  || '/' || ADRV.ASSGROOM\n            END)                      AS     ROOM       ,   -- 병실\n       ADRV.INRSR"
+"VREM AS PAMNOTE --원무참고사항\n  FROM PAM.PMIHADRV ADRV,\n       COM.ZSUMUSRB USRB,\n       PAM.PMCMPTBS PTBS,\n       COM.ZS"
+"DDDEPT ZDEP,\n       EMR.MMBDHRCD MRCD,\n       KIJUN\n WHERE ADRV.INRSRVSTAT IN ('S', 'R')\n   AND ADRV.ORDDRID = USRB."
+"USERID\n   AND ADRV.PID     = PTBS.PID\n   AND ADRV.INSTCD  = PTBS.INSTCD\n   AND ADRV.INSTCD  =  '014'\n   AND USRB.USE"
+"RFROMDD <= ADRV.INHOPEDD\n   AND USRB.USERTODD   >= ADRV.INHOPEDD\n   AND ZDEP.INSTCD = PTBS.INSTCD\n   AND ZDEP.DEPTCD "
+"= ADRV.ORDDEPTCD\n   AND ZDEP.VALIFROMDD<= ADRV.INHOPEDD\n   AND ZDEP.VALITODD >= ADRV.INHOPEDD\n   AND MRCD.INSTCD = PT"
+"BS.INSTCD\n   AND MRCD.TRGTCD = ADRV.ERREGLYN\n   AND MRCD.HARDCDNO='90'\n   AND MRCD.VALIFROMDD <=ADRV.INHOPEDD\n   AND"
+" MRCD.VALITODD >=ADRV.INHOPEDD\n   AND ADRV.INHOPEDD   >=  KIJUN.FROMDD\n   AND ADRV.INHOPEDD   <=  KIJUN.TODD\n ORDER B"
+"Y INHOPEDD";
        	...
        	row1.HNGNM = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row1.SEX = null;
							} else {
	                         		
        	row1.SEX = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row1.MPPHONTEL = null;
							} else {
	                         		
        	row1.MPPHONTEL = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 6) {
								row1.INHOPEDD = null;
							} else {
	                         		
        	row1.INHOPEDD = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 7) {
								row1.DEPTHNGNM = null;
							} else {
	                         		
        	row1.DEPTHNGNM = routines.system.JDBCUtil.getString(rs_tDBInput_2, 7, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 8) {
								row1.COLLABOTEAM = null;
							} else {
	                         		
        	row1.COLLABOTEAM = routines.system.JDBCUtil.getString(rs_tDBInput_2, 8, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 9) {
								row1.DOCTOR = null;
							} else {
	                         		
        	row1.DOCTOR = routines.system.JDBCUtil.getString(rs_tDBInput_2, 9, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 10) {
								row1.INGUBUN = null;
							} else {
	                         		
        	row1.INGUBUN = routines.system.JDBCUtil.getString(rs_tDBInput_2, 10, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 11) {
								row1.RESVGUBUN = null;
							} else {
	                         		
        	row1.RESVGUBUN = routines.system.JDBCUtil.getString(rs_tDBInput_2, 11, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 12) {
								row1.CP = null;
							} else {
	                         		
        	row1.CP = routines.system.JDBCUtil.getString(rs_tDBInput_2, 12, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 13) {
								row1.DIAG = null;
							} else {
	                         		
        	row1.DIAG = routines.system.JDBCUtil.getString(rs_tDBInput_2, 13, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 14) {
								row1.SURGERYHOPEDD = null;
							} else {
	                         		
        	row1.SURGERYHOPEDD = routines.system.JDBCUtil.getString(rs_tDBInput_2, 14, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 15) {
								row1.SURGERY = null;
							} else {
	                         		
        	row1.SURGERY = routines.system.JDBCUtil.getString(rs_tDBInput_2, 15, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 16) {
								row1.DRNOTE = null;
							} else {
	                         		
        	row1.DRNOTE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 16, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 17) {
								row1.ROOM = null;
							} else {
	                         		
        	row1.ROOM = routines.system.JDBCUtil.getString(rs_tDBInput_2, 17, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 18) {
								row1.PAMNOTE = null;
							} else {
	                         		
        	row1.PAMNOTE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 18, false);
		                    }
...
user_tmp.SEX = row1.SEX ;
user_tmp.MPPHONTEL = row1.MPPHONTEL ;
user_tmp.INHOPEDD = row1.INHOPEDD ;
user_tmp.DEPTHNGNM = row1.DEPTHNGNM ;
user_tmp.COLLABOTEAM = row1.COLLABOTEAM ;
user_tmp.DOCTOR = row1.DOCTOR ;
user_tmp.INGUBUN = row1.INGUBUN ;
user_tmp.RESVGUBUN = row1.RESVGUBUN ;
user_tmp.CP = row1.CP ;
user_tmp.DIAG = row1.DIAG ;
user_tmp.SURGERYHOPEDD = row1.SURGERYHOPEDD ;
user_tmp.SURGERY = row1.SURGERY ;
user_tmp.DRNOTE = row1.DRNOTE ;
user_tmp.ROOM = row1.ROOM ;
user_tmp.PAMNOTE = row1.PAMNOTE ;
user = user_tmp;
// ###############################
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "cmd /c java -Dfile.encoding=UTF-8 -jar CompactCTalkSender.jar " + context.cmctalk_out_user + " " + context.cmctalk_out_password + " " + context.cmctalk_out_roomno + " D:/data/ResvInpatient/입원예약정보_"+TalendDate.formatDate("yyyyMMdd", new Date()) + ".xls" ,env_tSystem_1,new java.io.File("D:/data/ResvInpatient/CompactCTalkSender"));
...
final Process ps_tSystem_2 = runtime_tSystem_2.exec( "cmd /c java -Dfile.encoding=UTF-8 -jar CompactCTalkSender.jar " + context.cmctalk_out_user + " " + context.cmctalk_out_password + " " + context.cmctalk_out_roomno + " none.txt" ,env_tSystem_2,new java.io.File("D:/data/ResvInpatient/CompactCTalkSender"));
 ...
 */
    ...
    public static void main(String[] args){
        final Reservation_Inpatient Reservation_InpatientClass = new Reservation_Inpatient();

        int exitCode = Reservation_InpatientClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Reservation_Inpatient.class.getClassLoader().getResourceAsStream("bucheon/reservation_inpatient_0_4/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Reservation_Inpatient.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("cmctalk_out_user", "id_String");
                            context.cmctalk_out_user=(String) context.getProperty("cmctalk_out_user");
                        context.setContextType("cmctalk_out_password", "id_String");
                            context.cmctalk_out_password=(String) context.getProperty("cmctalk_out_password");
                        context.setContextType("cmctalk_out_roomno", "id_String");
                            context.cmctalk_out_roomno=(String) context.getProperty("cmctalk_out_roomno");
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("cmctalk_out_user")) {
                context.cmctalk_out_user = (String) parentContextMap.get("cmctalk_out_user");
            }if (parentContextMap.containsKey("cmctalk_out_password")) {
                context.cmctalk_out_password = (String) parentContextMap.get("cmctalk_out_password");
            }if (parentContextMap.containsKey("cmctalk_out_roomno")) {
                context.cmctalk_out_roomno = (String) parentContextMap.get("cmctalk_out_roomno");
            }
        }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Reservation_Inpatient");
        }
...
/************************************************************************************************
 *     136568 characters generated by Talend Open Studio for Data Integration 
 *     on the 2022년 4월 28일 (목) 오전 10시 57분 24초
 ************************************************************************************************/