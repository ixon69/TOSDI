...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_26 = NL + "\t                java.security.Security.insertProviderAt(new oracle.security.pki.OraclePKIProvider(), 3);" + NL + "\t            ";
  ...
  protected final String TEXT_39 = NL + "    \tglobalMap.put(\"connectionType_\" + \"";
  protected final String TEXT_40 = "\", \"";
  protected final String TEXT_41 = NL + "\t\t\tSharedDBConnectionLog4j.initLogger(log.getName(),\"";
  protected final String TEXT_42 = NL + "\t\tString sharedConnectionName_";
  protected final String TEXT_43 = NL + "\t\t\tconn_";
  protected final String TEXT_44 = ",sharedConnectionName_";
  protected final String TEXT_45 = ");" + NL;
  protected final String TEXT_46 = NL + NL + "\t\t\t\tconn_";
  protected final String TEXT_47 = NL + "\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_48 = " = new java.util.Properties();";
  protected final String TEXT_49 = NL + "\t\t\t    if(dbUser_";
  protected final String TEXT_50 = "!=null && dbPwd_";
  protected final String TEXT_51 = "!=null && !\"\".equals(dbUser_";
  protected final String TEXT_52 = ")&& !\"\".equals(dbPwd_";
  ...
  protected final String TEXT_59 = ");" + NL + "\t\t\t    atnParamsPrope_";
  protected final String TEXT_60 = NL + "                System.setProperty(\"jsse.enableCBCProtection\",\"false\");";
  protected final String TEXT_61 = NL + "\t\t\tif(";
  protected final String TEXT_62 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_63 = ") && !\"\".equals(";
  protected final String TEXT_64 = ")){" + NL + "                atnParamsPrope_";
  protected final String TEXT_65 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_66 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "            }";
  protected final String TEXT_67 = NL + "             if(atnParamsPrope_";
  protected final String TEXT_68 = ".getProperty(\"javax.net.ssl.trustStoreType\")==null){" + NL + "                 atnParamsPrope_";
  protected final String TEXT_69 = ".put(\"javax.net.ssl.trustStoreType\",\"PKCS12\");" + NL + "             }" + NL + "             atnParamsPrope_";
  protected final String TEXT_70 = ".put(\"javax.net.ssl.trustStore\", ";
  protected final String TEXT_71 = " " + NL + "                 String trustStorePwd_";
  protected final String TEXT_72 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_73 = NL + "                 String trustStorePwd_";
  protected final String TEXT_74 = "; ";
  protected final String TEXT_75 = NL + "             if(trustStorePwd_";
  protected final String TEXT_76 = "!=null && trustStorePwd_";
  protected final String TEXT_77 = ".length()>0){" + NL + "                 atnParamsPrope_";
  protected final String TEXT_78 = ".put(\"javax.net.ssl.trustStorePassword\", trustStorePwd_";
  protected final String TEXT_79 = ");" + NL + "             }";
  protected final String TEXT_80 = NL + "                 if(atnParamsPrope_";
  protected final String TEXT_81 = ".getProperty(\"javax.net.ssl.keyStoreType\")==null){" + NL + "                     atnParamsPrope_";
  protected final String TEXT_82 = ".put(\"javax.net.ssl.keyStoreType\",\"PKCS12\");" + NL + "                 }" + NL + "                 atnParamsPrope_";
  protected final String TEXT_83 = ".put(\"javax.net.ssl.keyStore\", ";
  protected final String TEXT_84 = ");" + NL + "    ";
  protected final String TEXT_85 = NL + "    ";
  protected final String TEXT_86 = " " + NL + "                      String keyStorePwd_";
  protected final String TEXT_87 = NL + "                      String keyStorePwd_";
  protected final String TEXT_88 = NL + "                 if(keyStorePwd_";
  protected final String TEXT_89 = "!=null && keyStorePwd_";
  protected final String TEXT_90 = ".length()>0){" + NL + "                     atnParamsPrope_";
  protected final String TEXT_91 = ".put(\"javax.net.ssl.keyStorePassword\",keyStorePwd_";
  protected final String TEXT_92 = ");" + NL + "                 }";
  protected final String TEXT_93 = NL + "         " + NL + "\t\t\tconn_";
  protected final String TEXT_94 = ", atnParamsPrope_";
  protected final String TEXT_95 = NL + "        globalMap.put(\"localServiceName_\" + \"";
  protected final String TEXT_96 = "\",";
  protected final String TEXT_97 = NL + "        globalMap.put(\"rac_url_\" + \"";
  protected final String TEXT_98 = "\", ";
  protected final String TEXT_99 = NL + "        globalMap.put(\"host_\" + \"";
  protected final String TEXT_100 = ");" + NL + "        globalMap.put(\"port_\" + \"";
  protected final String TEXT_101 = ");" + NL + "        globalMap.put(\"dbname_\" + \"";
  ...
  protected final String TEXT_112 = NL + "\t" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_113 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_114 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_115 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_116 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_117 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_118 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_119 = " - Written records count: \" + nb_line_";
  protected final String TEXT_120 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_121 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_122 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_123 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_124 = " - Writing the record \" + nb_line_";
  protected final String TEXT_125 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_126 = " - Processing the record \" + nb_line_";
  protected final String TEXT_127 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_128 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_129 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_130 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_131 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_132 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_133 = " - Uses an existing connection ";
  protected final String TEXT_134 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_136 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_137 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_138 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_140 = ", dbUser_";
  protected final String TEXT_141 = ", dbPwd_";
  protected final String TEXT_142 = ");" + NL + "\t\t\t";
  protected final String TEXT_143 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_144 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_145 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\tif(\"com.mysql.cj.jdbc.Driver\".equals((String)globalMap.get(\"driverClass_";
  protected final String TEXT_147 = "\"))" + NL + "\t\t\t    && routines.system.BundleUtils.inOSGi()) {" + NL + "\t\t\t        Class.forName(\"com.mysql.cj.jdbc.AbandonedConnectionCleanupThread\")." + NL + "\t\t\t            getMethod(\"checkedShutdown\").invoke(null, (Object[]) null);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_148 = NL + "\t\t\t\tconn_";
  protected final String TEXT_149 = NL + "\t\t\t\tlog.";
  protected final String TEXT_150 = "(\"";
  protected final String TEXT_151 = " - \" + ";
  protected final String TEXT_152 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_153 = NL + "\t    \t\tlog.";
  protected final String TEXT_154 = "\");" + NL + "\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_156 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_157 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_158 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_159 = ": pstmt_";
  protected final String TEXT_160 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_161 = " += (countEach_";
  protected final String TEXT_162 = " < 0 ? 0 : ";
  protected final String TEXT_163 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_164 = NL + "\t";
  protected final String TEXT_165 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_166 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  ...
  protected final String TEXT_170 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_171 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_172 = ".get(dsAlias_";
  protected final String TEXT_173 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_174 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_175 = " = dataSources_";
  protected final String TEXT_176 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_177 = ");" + NL + "\t}";
  protected final String TEXT_178 = NL + "\tif (null != conn_";
  protected final String TEXT_179 = ") {" + NL + "\t\t";
  protected final String TEXT_180 = NL + "\t}";
  protected final String TEXT_181 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_182 = "\",conn_";
  protected final String TEXT_183 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_184 = ".getMetaData().getUserName());";
  protected final String TEXT_185 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_186 = NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_187 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
  protected final String TEXT_188 = "\",dbPwd_";
