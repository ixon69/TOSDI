...
public class TContextLoadMainJava
{
  ...
  protected final String TEXT_86 = ");" + NL + "        }" + NL + "    }catch(java.lang.Exception e){";
  protected final String TEXT_87 = NL + "            log.error(\"";
  protected final String TEXT_88 = " - Setting a value for the key \\\"\" + key_";
  protected final String TEXT_89 = " + \"\\\" has failed. Error message: \" + e.getMessage());";
  protected final String TEXT_90 = NL + "        System.err.println(\"Setting a value for the key \\\"\" + key_";
  protected final String TEXT_91 = " + \"\\\" has failed. Error message: \" + e.getMessage());" + NL + "    }" + NL + "        nb_line_";
